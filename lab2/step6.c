 ...
 * Date: 12th Jan 2026
 * Title: Lab2 - Step 6 - 
 * Description: Creates 5 processes including parent with different delays
 */
...
int main(int argc, char *argv[]) {
    int process_count = 5; // Total number of processes including parent
    if (argc != 6){
        printf ("Usage: %s <delay1> <delay2> <delay3> <delay4> <delay5> <delay6> \n",argv[0]);
        exit(0);
    }    
